...
// existing BC 530/532 semantics are changed.
//=============================================================================
...
namespace cbs
{
    namespace turbulence
    {
        ...
        {
            // Smooth-wall Spalding constants. kappa is consistent with the
            // standard SA constant already used by CBS3D. B=5.2 is a common
            // smooth-wall intercept and remains configurable for verification.
            Real kappa = 0.41;
        ...
        {
        public:
            // Spalding's continuous smooth-wall relation:
            //
            // y+ = u+ + exp(-kappa B)
            ...
            // The normal is normalized internally, so n and -n give the same
            // tangential velocity.
