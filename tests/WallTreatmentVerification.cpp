...
int main()
{
    ...
    {
        // --------------------------------------------------------------------
        // 1. Tangential projection and normal-orientation invariance.
        // --------------------------------------------------------------------
            ...
            magnitude(
                {
                    ...
                    tangent_positive[2] - tangent_negative[2]
                }) > 1.0e-14)
        {
        ...
        // --------------------------------------------------------------------
        // 2. Viscous-sublayer asymptote.
        //
        // For y+ << 1, Spalding tends to u+=y+. Therefore:
        //
        //     tau_w -> rho nu U_t / y = mu U_t / y.
        // --------------------------------------------------------------------
        const Real rho = 4.0;
        ...
        const Real analytic_viscous_shear =
            rho * nu * velocity / y;
        ...
        // --------------------------------------------------------------------
        // 3. Exact wall-unit identity in a representative wall-function range.
        // The selected data give Re_y = 700 and y+ approximately 48.
        // --------------------------------------------------------------------
        ...
        // --------------------------------------------------------------------
        // 4. Wall shear must be tangent to the wall and dissipative.
        // --------------------------------------------------------------------
        ...
        // --------------------------------------------------------------------
        // 5. Flipping the geometric face normal must not change the shear.
        // --------------------------------------------------------------------
        ...
        if (magnitude(
                {
                    ...
                    log_layer.wall_shear_on_fluid[2] - flipped.wall_shear_on_fluid[2]
                }) > 1.0e-12)
        {
        ...
        // --------------------------------------------------------------------
        // 6. Purely normal sampled velocity has zero modeled wall shear.
        // --------------------------------------------------------------------
        ...
        // --------------------------------------------------------------------
        // 7. Invalid geometry is rejected rather than silently normalized.
        // --------------------------------------------------------------------
